...
class GoogleMapAPI 
{
    ...
    /**Center of the gmap **/
    protected $center = 'Sarajevo Bosnia';
    ...
    public function init() {
        ...
        if ($this->includeJs === TRUE) {
            // Google map JS
            $this->content .= '<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?v=3.exp&key=AIzaSyDaSJ3rUtPgblICajPu5INBePFKF41ukDQ&language=' . $this->lang . '">';
            $this->content .= '</script>' . "\n";
