	...
	<div class="tab-pane" id="tab_2">
		<div class="portlet box red">
			<div class="portlet-title">
				<div class="caption"> <i class="fa fa-pencil"></i>تعديل مشروع </div>
				<div class="tools">
			...
			<div class="portlet-body form">
				<!-- BEGIN FORM-->
				<form action="<?= BaseUrl ?>admin-panel/project/update/<?= $project['id'] ;?>" method="post" class="form-horizontal" enctype="multipart/form-data">
					...
					<div class="form-body">
						...
						<div class="row">
							...
							<?php endif; ?>	
									...
									<div class="col-md-9">
									<input type="text" class="form-control" name="title" id="inputError" value="<?= $project['title'] ;?>" required>
										<?php if ( !empty( $errTitle ) ) : ?>
							...
							<?php endif; ?>	
									...
									<div class="col-md-9">
									<input type="text" class="form-control" name="address" id="inputError" value="<?= $project['address'] ;?>" required>
										<?php if ( !empty( $errAddress ) ) : ?>
						...
						<div class="row">
							...
							<?php endif; ?>	
									...
									<div class="col-md-9">
									<input type="text" class="form-control" name="current_phase" id="inputError" value="<?= $project['current_phase'] ;?>" required>
										<?php if ( !empty( $errPhase ) ) : ?>
						...
						<div class="col-md-6">
								<div class="form-group">
									...
									<div class="col-md-9">
										<textarea type="text" name="details" class="form-control" placeholder="تفاصيل العقار"> <?= $project['details'] ;?> </textarea>
									 </div>
								</div>
							</div>
							<!--/span-->
						...
						<div class="row">
							<div class="col-md-6">
								...
								<?php endif; ?>
									...
									<div class="col-md-9">
									<input type="text" name="lang" id="lng" value="<?= $project['lang'] ;?>" class="form-control " onClick="" placeholder="55.326412895414">
										<?php if ( !empty( $errLang ) ) : ?>															
										<div class="row">
							...
							<div class="col-md-6">
								...
								<?php endif; ?>
									...
									<div class="col-md-9">
									<input type="text" id="lat" class="form-control " onClick="" value="<?= $project['lat'] ;?>" name="lat" placeholder="51.326499898814">
										<?php if ( !empty( $errLat ) ) : ?>															
										<div class="row">
